declare class CircleCollider implements Collider {
    position: Point;
    radius: number;
...
declare class ClearEvent implements GameEvent {
    name: string;
    constructor(name: string);
    apply(world: World, x: number, y: number): void;
}
declare class SpawnEvent implements GameEvent {
    name: string;
    radius: number;
    phase: number;
    speed: number;
...
declare class ConditionalEvent implements GameEvent {
    health: number;
    events: GameEvent[];
    constructor(input: any);
    apply(world: World, x: number, y: number): void;
}
declare class GameScript {
    private events;
...
declare class Boss implements Entity {
    x: number;
    y: number;
    private script;
    private health;
...
declare class Bullet implements Entity {
    x: number;
    y: number;
    private radius;
    private color;
...
declare class Player implements Entity {
    x: number;
    y: number;
    private originalX;
    private originalY;
...
declare class Spawner implements Entity {
    x: number;
    y: number;
    name: string;
    private movement;
...
declare class LinePattern implements MovementPattern {
    private direction;
    private speedMag;
    private speed;
...
declare class GameWorld implements World {
    definedSpawners: any;
    player: Player;
    boss: Boss;
    bullets: Bullet[];
